...
{
    public static class WeaponPresetHelper
    {
        public static void ProcessWeaponPresets(CustomItemConfig itemConfig, string itemId, DatabaseTables tables)
        {
            ...
            {
                Log.Warn( "WeaponPresets list is null. Skipping.");
                return;
            }
            ...
            foreach (var presetData in itemConfig.WeaponPresets)
            {
                ...
                {
                    Log.Warn(
                        $"Preset {presetData.Id} has no items defined. Skipping.");
                    continue;
                }
